...
interface ICardServiceSecutityProps {
  title: string;
}
//https://cdn.worldvectorlogo.com/logos/g4s-logo-.svg

const CardServiceSecutity: FC<ICardServiceSecutityProps> = ({ title }) => {
  return (
    <div className="inline-flex h-[185.50px] w-[278.12px] items-center justify-end rounded-[20px] bg-zinc-300/50 pb-[24.50px] pl-[22px] pr-[17.12px] pt-[26px]">
      <div className="relative h-[135px] w-[239px]">
        ...
        <div className="absolute left-[1.21px] top-[112.14px] my-2 h-[3px] w-[231.69px] rounded-full bg-gray-600">
