...
interface IDataTableFacetedFilter<TData> {
  column?: Column<TData>;
  title?: string;
  options: {
    label: string;
    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="sm"
          className="h-8 border border-dashed border-muted/50 text-muted"
        >
                ...
                return (
                  <CommandItem
                    ...
                    onSelect={() => {
                      ...
                      column?.setFilterValue(filterValues.length ? filterValues : '');
                      console.log(column);
                    }}
                  >
                    <div
                    ...
                    {option.icon && <option.icon className="mr-2 h-4 w-4 text-muted" />}
